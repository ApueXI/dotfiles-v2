return {
      ...
      config = function()
        require('mason').setup {
          registries = {
            ...
            'github:Crashdummyy/mason-registry', -- custom registry for roslyn/rzls
          },
        }
      end,
    },
    'seblyng/roslyn.nvim', -- Roslyn LSP
    'tris203/rzls.nvim', -- Razor LSP
    -- other dependencies... -- NOTE: Must be loaded before dependants
    -- mason-lspconfig:
  ...
  config = function()
    ...
    -- Define sign symbols (this is what was missing!)
